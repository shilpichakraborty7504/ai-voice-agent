...
# Create dat contracts using Pydantic models
...
# Create FastAPI application and endpoints pseudo code
...
def cancel_appointment(request: CancelAppointmentRequest , db: Session = Depends(get_db)):
    ...
    # logic to cancel appointment, update/delete row to database.
